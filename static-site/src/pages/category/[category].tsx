...
export function CategoryPage({ 
  ...
  const title = `${category} - 記事一覧 | magnolia`;
  const description = `${category}に関する記事一覧です。${articles.length}件の記事があります。`;
    ...
    <BaseLayout title={title} description={description}>
      <div class="container mx-auto px-4 py-8">
        <Breadcrumb items={[
          ...
          { name: "カテゴリ", href: "/magnolia/category" },
          { name: category, href: `/magnolia/category/${categoryToSlug(category)}.html` }
        ]} />
        ...
        {articles.length === 0 ? (
          ...
          <>
            ...
            <Pagination 
              ...
              baseUrl={`/magnolia/category/${categoryToSlug(category)}.html`}
