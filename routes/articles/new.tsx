...
export const handler: Handlers<Data> = {
  ...
  async POST(req, ctx) {
    ...
    try {
      ...
      console.log("フォームデータ:", { title, slug, body, category, tags, pub_date });
...
export default function NewArticlePage({ data }: PageProps<Data>) {
  return (
    <div class="container mx-auto p-4">
      <div class="max-w-4xl mx-auto">
        {/* ヘッダー */}
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
          <h1 class="text-2xl sm:text-3xl font-bold">記事作成</h1>
          <a
            href="/articles"
          ...
          <form method="POST" class="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                id="pub_date"
                name="pub_date"
                value={data?.formData?.pub_date || new Date().toISOString().split('T')[0]}
                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
